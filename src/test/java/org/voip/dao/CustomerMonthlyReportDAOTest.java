...
public class CustomerMonthlyReportDAOTest {
	...
	public void testStoredProcedures(){
		...
		try {
			...
			CustomerMonthlyTotalReport total=customerMonthlyReportDAO.getReportByMonthACustomer(date, 7139375437L);
			
			System.out.println(total.getTotalCost()+":size of List:"+total.getAllCustomerMonthly().size());
